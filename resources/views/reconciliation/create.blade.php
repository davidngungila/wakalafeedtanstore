        ...
        <div class="panel-body" style="padding:0;">
            ...
            @if($dayTransactions->isNotEmpty())
                <div style="padding:12px 16px; background:var(--sand-50); border-top:1px solid var(--line); display:flex; gap:12px; flex-wrap:wrap; font-size:13px;">
                    ...
                    <span style="color:var(--ink-soft);">Cash in (deposits + airtime + send_money): @money($dayTransactions->whereIn('type', ['deposit','float_deposit','airtime','send_money'])->sum('amount')) · Cash out (withdrawals): @money($dayTransactions->where('type','withdrawal')->sum('amount'))</span>
                </div>
            @endif
